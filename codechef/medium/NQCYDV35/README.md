...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-08-17T16:55:35.011Z  
...
class CodeChef {
    public static void main(String[] args) {
        int numerator = 10;
        int denominator = 1; // Change the denominator to 1 to avoid the error and get correct output.
...
[View on CodeChef](https://www.codechef.com/problems/NQCYDV35)